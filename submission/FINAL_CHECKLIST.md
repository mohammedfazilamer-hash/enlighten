...
- [x] README renders correctly and contains setup, sample data, and testing guidance.
...
- [x] Pixel phone is connected and the newest APK is installed.
- [x] Ollama has `llama3.2:3b` and the connection test passes.
- [x] Profile uses the generic icon, not a personal photo.
- [x] Demo passage produces a useful explanation and four study cards.
...
1. Lock the working APK and capture the phone demo.
2. Finish and upload the video.
3. Push and independently verify the repository.
4. Paste the reviewed submission copy.
5. Add URLs and the `/feedback` ID.
6. Submit early enough to recover from upload or sign-in problems.
